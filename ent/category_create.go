...
func (cc *CategoryCreate) SetShopCategoryID(id int) *CategoryCreate {
	cc.mutation.SetShopCategoryID(id)
	return cc
}

// SetNillableShopCategoryID sets the "shop_category" edge to the ShopCategory entity by ID if the given value is not nil.
func (cc *CategoryCreate) SetNillableShopCategoryID(id *int) *CategoryCreate {
	if id != nil {
		cc = cc.SetShopCategoryID(*id)
	}
	return cc
}

// SetShopCategory sets the "shop_category" edge to the ShopCategory entity.
func (cc *CategoryCreate) SetShopCategory(s *ShopCategory) *CategoryCreate {
	return cc.SetShopCategoryID(s.ID)
}
...
func (cc *CategoryCreate) AddProductCategoryIDs(ids ...int) *CategoryCreate {
...
func (cc *CategoryCreate) AddProductCategories(s ...*SellerProductCategory) *CategoryCreate {
	ids := make([]int, len(s))
	for i := range s {
		ids[i] = s[i].ID
	}
...
func (cc *CategoryCreate) createSpec() (*Category, *sqlgraph.CreateSpec) {
	...
	if nodes := cc.mutation.ShopCategoryIDs(); len(nodes) > 0 {
		...
		_node.shop_category_categories = &nodes[0]
