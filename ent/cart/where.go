...
func Slug(v string) predicate.Cart {
	return predicate.Cart(func(s *sql.Selector) {
...
func SlugEQ(v string) predicate.Cart {
	return predicate.Cart(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldSlug), v))
	})
}
...
func SlugNEQ(v string) predicate.Cart {
	return predicate.Cart(func(s *sql.Selector) {
...
func SlugIn(vs ...string) predicate.Cart {
...
func SlugNotIn(vs ...string) predicate.Cart {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func SlugGT(v string) predicate.Cart {
	return predicate.Cart(func(s *sql.Selector) {
...
func SlugGTE(v string) predicate.Cart {
	return predicate.Cart(func(s *sql.Selector) {
...
func SlugLT(v string) predicate.Cart {
	return predicate.Cart(func(s *sql.Selector) {
...
func SlugLTE(v string) predicate.Cart {
	return predicate.Cart(func(s *sql.Selector) {
...
func SlugContains(v string) predicate.Cart {
	return predicate.Cart(func(s *sql.Selector) {
...
func SlugHasPrefix(v string) predicate.Cart {
	return predicate.Cart(func(s *sql.Selector) {
...
func SlugHasSuffix(v string) predicate.Cart {
	return predicate.Cart(func(s *sql.Selector) {
...
func SlugEqualFold(v string) predicate.Cart {
	return predicate.Cart(func(s *sql.Selector) {
...
func SlugContainsFold(v string) predicate.Cart {
	return predicate.Cart(func(s *sql.Selector) {
...
func HasCartProducts() predicate.Cart {
	return predicate.Cart(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasCartProductsWith(preds ...predicate.CartProduct) predicate.Cart {
	return predicate.Cart(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasCheckout() predicate.Cart {
	return predicate.Cart(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasCheckoutWith(preds ...predicate.Checkout) predicate.Cart {
	return predicate.Cart(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
