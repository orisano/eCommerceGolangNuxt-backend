...
func columnChecker(table string) func(string) error {
	checks := map[string]func(string) bool{
		...
		checkoutproduct.Table:              checkoutproduct.ValidColumn,
		sellerproduct.Table:                sellerproduct.ValidColumn,
		sellerproductcategory.Table:        sellerproductcategory.ValidColumn,
		sellerproductimage.Table:           sellerproductimage.ValidColumn,
		sellerproductvariation.Table:       sellerproductvariation.ValidColumn,
