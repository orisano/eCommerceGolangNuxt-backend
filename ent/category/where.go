...
func HasShopCategory() predicate.Category {
	return predicate.Category(func(s *sql.Selector) {
...
func HasShopCategoryWith(preds ...predicate.ShopCategory) predicate.Category {
	return predicate.Category(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasProductCategories() predicate.Category {
	return predicate.Category(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(ProductCategoriesTable, FieldID),
...
func HasProductCategoriesWith(preds ...predicate.SellerProductCategory) predicate.Category {
	return predicate.Category(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
