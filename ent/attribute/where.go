...
func HasAttribute() predicate.Attribute {
	return predicate.Attribute(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(AttributeTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, AttributeTable, AttributeColumn),
		)
...
func HasAttributeWith(preds ...predicate.SellerProductVariationValues) predicate.Attribute {
	return predicate.Attribute(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
