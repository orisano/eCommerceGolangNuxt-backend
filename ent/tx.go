...
func (tx *Tx) init() {
	...
	tx.CheckoutProduct = NewCheckoutProductClient(tx.config)
	tx.SellerProduct = NewSellerProductClient(tx.config)
	tx.SellerProductCategory = NewSellerProductCategoryClient(tx.config)
	tx.SellerProductImage = NewSellerProductImageClient(tx.config)
	tx.SellerProductVariation = NewSellerProductVariationClient(tx.config)
