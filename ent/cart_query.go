...
func (cq *CartQuery) QueryCartProducts() *CartProductQuery {
	query := &CartProductQuery{config: cq.config}
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := cq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (cq *CartQuery) QueryCheckout() *CheckoutQuery {
	query := &CheckoutQuery{config: cq.config}
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := cq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
// Returns a *NotSingularError when exactly one Cart entity is not found.
...
// Returns a *NotSingularError when exactly one Cart ID is not found.
...
func (cq *CartQuery) Clone() *CartQuery {
	...
	return &CartQuery{
		...
		withCheckout:     cq.withCheckout.Clone(),
...
func (cq *CartQuery) WithCartProducts(opts ...func(*CartProductQuery)) *CartQuery {
	query := &CartProductQuery{config: cq.config}
	for _, opt := range opts {
		opt(query)
	}
...
func (cq *CartQuery) WithCheckout(opts ...func(*CheckoutQuery)) *CartQuery {
	query := &CheckoutQuery{config: cq.config}
	for _, opt := range opts {
		opt(query)
	}
	cq.withCheckout = query
	return cq
}
...
func (cq *CartQuery) sqlAll(ctx context.Context) ([]*Cart, error) {
	...
	if query := cq.withUser; query != nil {
		...
		for i := range nodes {
			if nodes[i].user_carts == nil {
				continue
			}
			fk := *nodes[i].user_carts
		...
		for _, n := range neighbors {
			...
			if !ok {
				return nil, fmt.Errorf(`unexpected foreign-key "user_carts" returned %v`, n.ID)
			}
			for i := range nodes {
	...
	if query := cq.withCartProducts; query != nil {
		...
		query.Where(predicate.CartProduct(func(s *sql.Selector) {
			s.Where(sql.InValues(cart.CartProductsColumn, fks...))
		}))
		neighbors, err := query.All(ctx)
		if err != nil {
			return nil, err
		...
		for _, n := range neighbors {
			fk := n.cart_cart_products
			if fk == nil {
				return nil, fmt.Errorf(`foreign-key "cart_cart_products" is nil for node %v`, n.ID)
			}
			node, ok := nodeids[*fk]
			if !ok {
				return nil, fmt.Errorf(`unexpected foreign-key "cart_cart_products" returned %v for node %v`, *fk, n.ID)
			}
			node.Edges.CartProducts = append(node.Edges.CartProducts, n)
		}
	}

	if query := cq.withCheckout; query != nil {
		fks := make([]driver.Value, 0, len(nodes))
		nodeids := make(map[int]*Cart)
		for i := range nodes {
			fks = append(fks, nodes[i].ID)
		...
		query.Where(predicate.Checkout(func(s *sql.Selector) {
			s.Where(sql.InValues(cart.CheckoutColumn, fks...))
		}))
		neighbors, err := query.All(ctx)
		if err != nil {
			return nil, err
		...
		for _, n := range neighbors {
			fk := n.cart_checkout
			if fk == nil {
				return nil, fmt.Errorf(`foreign-key "cart_checkout" is nil for node %v`, n.ID)
			}
			node, ok := nodeids[*fk]
			if !ok {
				return nil, fmt.Errorf(`unexpected foreign-key "cart_checkout" returned %v for node %v`, *fk, n.ID)
			}
			node.Edges.Checkout = n
		}
	}
...
// It is only allowed when executing a group-by query with one field.
func (cgb *CartGroupBy) String(ctx context.Context) (_ string, err error) {
	var v []string
	...
	case 0:
		err = &NotFoundError{cart.Label}
	default:
		err = fmt.Errorf("ent: CartGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}

// StringX is like String, but panics if an error occurs.
func (cgb *CartGroupBy) StringX(ctx context.Context) string {
...
// It is only allowed when executing a group-by query with one field.
func (cgb *CartGroupBy) Int(ctx context.Context) (_ int, err error) {
	var v []int
	...
	case 0:
		err = &NotFoundError{cart.Label}
	default:
		err = fmt.Errorf("ent: CartGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}

// IntX is like Int, but panics if an error occurs.
func (cgb *CartGroupBy) IntX(ctx context.Context) int {
	v, err := cgb.Int(ctx)
	if err != nil {
		panic(err)
	}
...
// It is only allowed when executing a group-by query with one field.
func (cgb *CartGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	var v []float64
	...
	case 0:
		err = &NotFoundError{cart.Label}
	default:
		err = fmt.Errorf("ent: CartGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}

// Float64X is like Float64, but panics if an error occurs.
func (cgb *CartGroupBy) Float64X(ctx context.Context) float64 {
...
// It is only allowed when executing a group-by query with one field.
func (cgb *CartGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	var v []bool
	...
	case 0:
		err = &NotFoundError{cart.Label}
	default:
		err = fmt.Errorf("ent: CartGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}

// BoolX is like Bool, but panics if an error occurs.
func (cgb *CartGroupBy) BoolX(ctx context.Context) bool {
	v, err := cgb.Bool(ctx)
	if err != nil {
		panic(err)
	}
...
func (cs *CartSelect) String(ctx context.Context) (_ string, err error) {
	var v []string
	...
	case 0:
		err = &NotFoundError{cart.Label}
	default:
		err = fmt.Errorf("ent: CartSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}

// StringX is like String, but panics if an error occurs.
func (cs *CartSelect) StringX(ctx context.Context) string {
	v, err := cs.String(ctx)
	if err != nil {
		panic(err)
	}
...
func (cs *CartSelect) Int(ctx context.Context) (_ int, err error) {
	var v []int
	...
	case 0:
		err = &NotFoundError{cart.Label}
	default:
		err = fmt.Errorf("ent: CartSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}

// IntX is like Int, but panics if an error occurs.
func (cs *CartSelect) IntX(ctx context.Context) int {
	v, err := cs.Int(ctx)
	if err != nil {
		panic(err)
	}
...
func (cs *CartSelect) Float64(ctx context.Context) (_ float64, err error) {
	var v []float64
	...
	case 0:
		err = &NotFoundError{cart.Label}
	default:
		err = fmt.Errorf("ent: CartSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}

// Float64X is like Float64, but panics if an error occurs.
func (cs *CartSelect) Float64X(ctx context.Context) float64 {
...
func (cs *CartSelect) Bool(ctx context.Context) (_ bool, err error) {
	var v []bool
	...
	case 0:
		err = &NotFoundError{cart.Label}
	default:
		err = fmt.Errorf("ent: CartSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}

// BoolX is like Bool, but panics if an error occurs.
func (cs *CartSelect) BoolX(ctx context.Context) bool {
	v, err := cs.Bool(ctx)
	if err != nil {
		panic(err)
	}
